...
class TravellingMapScreen extends StatefulWidget {
  const TravellingMapScreen({super.key, required this.selectedPlaces});

  final Set<String> selectedPlaces;

  @override
  // ignore: library_private_types_in_public_api
  _TravellingMapScreenState createState() => _TravellingMapScreenState();
}

class _TravellingMapScreenState extends State<TravellingMapScreen> {
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  for (String place in widget.selectedPlaces) Text(place),
                ],
              ),
            ),
            const SizedBox(
...
class NavigationScreen extends StatefulWidget {
  ...
  const NavigationScreen(this.lat, this.lng,
      {super.key, required this.selectedPlaces});
